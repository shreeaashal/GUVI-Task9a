...
const paginationContainer = document.getElementById('buttons');
  ...
  const totalPages = Math.ceil(jsonData.length / 5); 
  ...
  function generatePaginationButtons(totalPages) {
    ...
    prevButton.addEventListener('click', () => handlePageChange(getCurrentPage() - 1));
    ...
    nextButton.addEventListener('click', () => handlePageChange(getCurrentPage() + 1));
  ...
  function updateTableData(pageNumber) {
    tableBody.innerHTML = '';
